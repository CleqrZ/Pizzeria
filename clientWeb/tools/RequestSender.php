...
class requestSender
{
    ...
    public static function sendGetRequest($table) {
        $url_request = "http://localhost/Pizerria-Groupe-5/server/".$table;
    ...
    public static function sendPostRequest($table, $data_to_send)	{
        $url_request = "http://localhost/Pizerria-Groupe-5/server/".$table;
        $data_encoded = null;
    ...
    public static function sendDeleteRequest($table,$id)	{
        $url_request = "http://localhost/Pizerria-Groupe-5/server/".$table."/".$id;
        $curl = curl_init($url_request);
    ...
    public static function sendPutRequest($table, $data_to_send)	{
        $url_request = "http://localhost/Pizerria-Groupe-5/server/".$table;
        $data_encoded = null;
        if ($data_to_send != null && (is_array($data_to_send) || is_object($data_to_send) )) {
            $data_encoded = json_encode($data_to_send);
